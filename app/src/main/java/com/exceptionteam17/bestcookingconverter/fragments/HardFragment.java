...
//        editFrom.getBackground().setColorFilter(ContextCompat.getColor(myView.getContext(), R.color.textColor), PorterDuff.Mode.SRC_ATOP);
        ...
        myView.findViewById(R.id.viewToHide).setVisibility(View.GONE);
        myView.findViewById(R.id.viewToHide2).setVisibility(View.GONE);
        myView.findViewById(R.id.viewToShow).setVisibility(View.VISIBLE);
        myView.findViewById(R.id.viewToShow2).setVisibility(View.VISIBLE);
